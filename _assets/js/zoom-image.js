(function () {
    ...
    /* Custom zoom-image plugin from Docsify to unable configuration using window.$docsify | https://cdn.jsdelivr.net/npm/docsify/lib/plugins/zoom-image.js */
    ...
    function install(hook, vm) {
        ...
        hook.doneEach(function (_) {
            ...
            zoom = mediumZoom(elms, vm.config.zoomImage);
        });
    }
